...
Note: each different AtomJump Server installation has it’s own private users database. If your account was set up on AtomJump.com, then the account will be consistent across all atomjump.com properties, but, it will not necessarily work in every version of the messaging popup that you might find, because these are run by other companies.
