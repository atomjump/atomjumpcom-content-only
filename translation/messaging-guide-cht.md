...
注意：這些視頻論壇是公共的，除非您是在私人論壇上，並且在新用戶加入之前必須接受他們，但在此之後，您對顯示給他人的內容應保持謹慎。如果您想在這裡獲得私密性，則應該開始一個一次性的會話，或購買一個私人論壇。
...
注意：每個不同的AtomJump Server安裝都有其自己的私人用戶數據庫。如果您的帳戶是在AtomJump.com上設置的，則該帳戶在所有atomjump.com屬性上都將保持一致，但是，該帳戶不一定能在您可能會找到的每個版本的消息彈出窗口中使用，因為它們是由其他公司運營。
...
## 設置組
與您的論壇共享論壇的網址。您可以通過點擊底層頁面右上角的“共享”圖標，在atomjump.com上快速找到此內容。然後，每個人都可以選擇成為論壇訂戶以獲取正在進行的通知。

## 設置私人小組
在atomjump.org上，您可以輸入群組名稱，然後點擊底部的“創建私人群組”。這將自動為我們填寫一封電子郵件。請在發送電子郵件之前替換組密碼。在atomjump.org上，這是每年10美元的費用，您可以在此頁面上註冊。在其他論壇上，您應該與系統管理員聯繫以添加論壇密碼。

注意：此論壇密碼與您的個人密碼不同，應該是您可以舒適地通過電子郵件發送給論壇中每個成員的密碼。
...
注意：如果周圍的站點已實現此功能，則前面帶有“設置”一詞的灰色框只會更改語言。更改語言會更改中心框中的“指南”消息。它不會影響其他用戶輸入的文本。
...
任何人都可以刪除AtomJump.com上的任何消息，我們允許這樣做，以便論壇在很大程度上可以自我調節。儘管這可能意味著您的消息被某人不公平地刪除，但這確實意味著只有所有人認可的消息才會保留在論壇上。如果您有此政策無法解決的問題，請在“隱私”頁面上與我們聯繫。
