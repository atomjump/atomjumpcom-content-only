...
Appuyez à nouveau sur le lien de l'application dans les paramètres, puis appuyez sur "ouvrir l'application" dans l'App-Store. Dans l'application, appuyez sur le bouton "Jumeler AtomJump.com" ou collez-le dans votre serveur privé et appuyez sur le bouton "Couplage du serveur privé". Si tout a fonctionné correctement, l'application doit indiquer "À l'écoute des messages" et le navigateur doit indiquer que vous avez associé votre application à votre adresse e-mail. Cela signifie que tous les messages privés apparaîtront.

Remarque: vous ne pouvez être connecté que sur un appareil à la fois.
...
Si vous ne recevez pas de notifications sur un iPhone, vous devrez peut-être accéder à "Paramètres> Notifications> Messagerie AtomJump" de votre téléphone et basculer les paramètres de notification sur "Autoriser les notifications".
