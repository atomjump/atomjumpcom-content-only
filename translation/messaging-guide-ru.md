...
__Примечание: __ это руководство представляет собой машинный перевод с английской версии на http://atomjump.org/wp/user-guide/. Если вы можете подтвердить, что перевод имеет смысл для вас, или улучшить перевод, свяжитесь с нами напрямую по адресу http://atomjump.org/wp/contact/ или внесите изменения на https://github.com/atomjump /изменить язык. Ваш вклад очень ценится.
...
Пожалуйста, заплатите мне 5 долларов Пожалуйста, заплатите мне 5 долларов [со ссылкой на Paypal]

Пожалуйста, заплатите мне 3,30 фунта Пожалуйста, заплатите мне 3,30 фунта [со ссылкой на Paypal]

https://youtu.be/ZNra8eK0K6k [показывает изображение видео, которое нужно щелкнуть]

london@ london@ [со ссылкой на http://london.atomjump.com]

london.atomjump.com london@ [со ссылкой на http://london.atomjump.com]

http://a.very.long.link.with.lots.of.text.com Разверните [со ссылкой на http://a.very.long.link.with.lots.of.text.com]

http://yoururl.com/yourpic.jpg [показывает изображение]
...
Примечание: каждая инсталляция AtomJump Server имеет собственную базу данных частных пользователей. Если ваша учетная запись была настроена на AtomJump.com, то учетная запись будет согласована для всех свойств atomjump.com, но она не обязательно будет работать во всех версиях всплывающих сообщений, которые вы можете найти, потому что они используются другими компаниями. .
...
Поделитесь веб-адресом вашего форума со своей группой. Вы можете быстро найти это на сайте atomjump.com, нажав значок «Поделиться» в правом верхнем углу соответствующей страницы. После этого каждый человек может стать подписчиком форума и получать постоянные уведомления.

## Чтобы создать частную группу
На сайте atomjump.org вы можете ввести имя группы и нажать на нижнюю запись «Создать частную группу». Это автоматически заполнит для нас электронное письмо. Пожалуйста, замените пароль группы перед отправкой электронного письма. На сайте atomjump.org это стоит 10 долларов США в год, и вы можете зарегистрироваться на этой странице. На других форумах вам следует обратиться к системному администратору, чтобы добавить пароль форума.

Примечание: этот пароль форума отличается от вашего личного пароля и должен быть таким, который вы можете отправить по электронной почте каждому члену группы.
...
Стоимость 16 центов за сообщение. Мы выставляем счет ежемесячно.
...
Вы можете подписаться на любое количество форумов. См. «Чтобы стать подписчиком форума» выше.
...
Примечание: фотографии лучше всего загружать как альбомные.
...
Примечание: переднее серое поле со словом «Настройки» изменит язык, только если окружающий сайт реализовал эту функцию. Смена языка приведет к изменению «справочных» сообщений в центральном окне. Это не влияет на текст, введенный другими пользователями.
...
** Эта функция включена по умолчанию на AtomJump.com, но может не быть, если ваш провайдер не включил эти плагины.
