...
На AtomJump․com вы можете ввести свое собственное уникальное название комнаты, где написано "Enter a group name", например "fredfamily" и нажмите на нижнюю запись "Create a PRIVATE room". На AtomJump․com это стоит 15 новозеландских долларов в год (примерно 10 долларов США в год), и вы можете зарегистрироваться на <a href="https://atomjump.com/wp/introduction/">этой странице</а>. На других форумах вам следует обратиться к системному администратору, чтобы добавить пароль приватного форума.
