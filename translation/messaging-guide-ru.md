...
На сайте atomjump.org вы можете ввести имя группы и нажать на нижнюю запись «Создать частную группу». Это автоматически заполнит для нас электронное письмо. Пожалуйста, замените пароль группы перед отправкой электронного письма. На AtomJump․com это стоит 10 долларов США в год, и вы можете зарегистрироваться на <a href="https://atomjump.com/wp/introduction/">этой странице</a>. На других форумах вам следует обратиться к системному администратору, чтобы добавить пароль форума.
