...
## 個室を設置するには
AtomJump․comでは、「グループ名を入力してください」と表示されている独自の部屋名を入力できます。例： 「fredfamily」をクリックし、一番下のエントリ「個室を作成」をタップします。 AtomJump․comでは、これはNZ $ 15 /年（約$ US 10 /年）で、<ahref = "https://atomjump.com/wp/introduction/">このページ</にサインアップできます。</a>。 他のフォーラムでは、システム管理者に連絡してプライベートフォーラムのパスワードを追加する必要があります。
